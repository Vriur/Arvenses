...
export const HELP = {
    ...
    MATCHING_OPTIONS_TEXT: '\n Si los atributos que usted ha escogido reducen el número de especies remanentes a un número pequeño, y su arvense desconocida no está entre ellas, hay tres posibles razones: \n\n\t\t1. La especie no está en la base de datos. Se ha hecho un importante esfuerzo para incluir tantas arvenses de café cómo fue posible, pero con los años será necesario seguir añadiendo especies. \n\n\t\t2. Hay un error en los datos. Esto es posible, si descubre algún error, por favor contactar a arvenses.eeafbm@ucr.ac.cr \n\n\t\t3. Usted escogió un atributo incorrecto. Por favor vaya al menú de marcas para revisarlas. Puede revisar, eliminar o cambiar cualquiera de las marcar que ha hecho, directamente en esa pantalla.',
};
